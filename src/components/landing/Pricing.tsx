...
const tiers = [
  ...
  },
  {
    ...
    features: ["Unlimited projects", "Priority GPU lanes", "Advanced agents", "100 GB storage", "Realtime collab", "Telemetry suite"],
    cta: "Launch Flux",
  ...
  },
  {
    ...
    features: ["Dedicated edge mesh", "On-prem render", "Custom models", "24/7 white-glove", "SOC 2 + HIPAA"],
    cta: "Talk to sales",
